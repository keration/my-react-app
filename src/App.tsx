...
import { getThemeGlowColor, useTheme } from './hooks/useTheme.ts';
      ...
      <div className="max-w-2xl mx-auto relative z-10">
        ...
        {userList.map((user) => (
          <div key={user.id} className="mb-6 card-fade-in">
            ...
            <div
              className="w-full rounded-lg animated-border shadow-lg card-hover-glow"
              style={{ color: getThemeGlowColor(themeColor), padding: '1px' }}
            >
